...
%
\begin{lstlisting} values 1 and -1 with probability $\frac{1}{2}$ each. Then $E(X_{1}+X_{2}+X_{3}+X_{4})^{4}$ equals
\begin{enumerate}
...
&=\hspace{-1 in}=\frac{\pr{X_{1}=1,X_{2}=1}}{\pr{X_{1}=1,X_{2}=1}+\pr{X_{1}=3,X_{2}=0}}\\
...
$\implies$ option 2 is incorrect, option 4 is correct\\
